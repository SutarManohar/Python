...
food1=food_items( '1','paneer biryani','1 plate','Rs.220','5%')    
food2=food_items('2','tandoori roti','1 pieces','Rs.20','5%')
food3=food_items('3', 'palak paneer','1 Plate', 'Rs.260','5%')
food4=food_items("4",'coco cola','750 ml','1 bottle','5%')
...
class list_of_food_items():
    ...
    foods=['paneer biryani','palak paneer','tandoori roti','coco cola']   

    for i in foods:
        print(i)
    
def removing_item_from_list():
    My_foods_list=['palak paneer','butter non roti', 'Vegan Burger']   
...
print(user1.registration('manohar',12345678,'sutar@606gmail','hyderabad','sutar'))
print(user1.login('sutar','manohar'))
...
for i in foods:
    ...
    def update_profile(update_profile):
        if "manohar" != "sutar manohar":
            return "\nprofile  updated"
        if 'manohar'=='shaik ismail':
            return '\nyour profile not  updated'
        
        
s1=update_profile('sutar manohar')
print(s1)
